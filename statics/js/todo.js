        ...
        success: function (response) {
            ...
            if (response.length == 0) {
                ...
                for (var i = 0; i < response.length; i++) {
                    ...
                    html += "<label class='form-check-label' for='defaultCheck1'>Done</label><button class='btn btn-primary' id='dlt' onclick='deleteTodo(" + response[i].pk + ")' type='submit'>Delete</button></div></div>";
                }
            }
